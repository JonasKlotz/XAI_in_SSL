...
def setup_model(name=None,
    ...
    if name == 'simclr':
        ...
        layers = [encoder.layer2[
                      2].conv3]  # [encoder.layer1[2].conv2] # [encoder.layer1[2].conv3] torch.Size([1, 256, 8, 8]) #[encoder.layer2[2].conv3] torch.Size([1, 512, 4, 4]) #[encoder.layer2[2].conv2] [1, 128, 4, 4])  # , encoder.fc]

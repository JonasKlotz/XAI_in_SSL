...
def train_vqvae_dataloader(working_path, train_loader, val_loader, test_loader, max_epochs=50, learning_rate=1e-3,
                           decay=0.99, commitment_cost=0.25, embedding_dim=16,  # 64,
                           num_residual_layers=2, num_residual_hiddens=32, num_hiddens=128, num_training_updates=15000,
                           batch_size=256):
